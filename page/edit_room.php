...
if (!$_SESSION['userid']) {
    ...
    $sqltype = "SELECT * FROM type_room";
    $resultt = mysqli_query($conn, $sqltype);
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" aria-label="Default select example" name="type">
                                                <?php
                                                // Assuming you have an active user ID you want to be selected by default
                                                $active_type_id = $row['type_r'];


                                                while ($rowtype = mysqli_fetch_assoc($resultt)) {
                                                    // Check if the current user ID matches the active user ID
                                                    $selected2 = ($rowtype['id_t'] == $active_type_id) ? 'selected' : '';
                                                ?>
                                                    <!-- Echo out the value and name for each option -->
                                                    <option value="<?php echo $rowtype['id_t']; ?>" <?php echo $selected2; ?>>
                                                        <?php echo $rowtype['name_t']; ?>
                                                    </option>
                                                <?php
                                                }
                                                ?>
                                    ...
                                    <div class="col-4 ">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" aria-label="Default select example" name="status_r">
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" aria-label="Default select example" name="live_r">
                                                <?php
                                                // Assuming you have an active user ID you want to be selected by default
                                                $active_user_id = $row['live_r'];

                                                while ($rowuser = mysqli_fetch_assoc($resultu)) {
                                                    // Check if the current user ID matches the active user ID
                                                    $selected = ($rowuser['id'] == $active_user_id) ? 'selected' : '';
                                                ?>
                                                    <option value="<?php echo $rowuser['id']; ?>" <?php echo $selected; ?>>
                                        ...
                                        <div class="mb-3">
                                            <input type="hidden" class="form-control" name="live_r2" value="<?php echo $active_user_id; ?>">
                                        </div>
                                    ...
                                    <div class="col-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="befor_wather" value="<?php echo $row['wather'] ?>">
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="mb-3">
                                            <label for="fname" class="form-label">เลขมาตรวัดไฟ</label>
                                            <input type="text" class="form-control" name="befor_electricity" value="<?php echo $row['electricity'] ?>">
                                        </div>
                                    </div>
                                </div>
