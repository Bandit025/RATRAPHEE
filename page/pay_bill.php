...
if (!$_SESSION['userid']) {
    ...
    WHERE a.status_r = 3 AND a.status_r != 1";
            ...
            <main class="col-10">
                ...
                <div class="container">
                    ...
                    <div class="row" style="display: grid; grid-template-columns: auto 1fr;">
                        <div class="col">
                            <h2 style="margin-right: auto;">ออกบิลค่าห้อง</h2>
                        </div>
                        <div class="col-3">
                        ...
                        <tbody>
                            <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                                <tr style="background-color: #fff;">
                                    ...
                                    <td style="text-align: center"><a href="pay_bill_form.php?id_r=<?php echo $row["id_r"] ?>" class="btn btn-outline-primary">ออกบิลค่าห้อง</a></td>
                                    <?php }else{?>
