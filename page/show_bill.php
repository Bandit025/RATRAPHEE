...
if (!$_SESSION['userid']) {
    ...
    INNER JOIN bill_status b ON a.status_b=b.id_bs
    INNER JOIN room c ON a.room_b=c.id_r";
    ...
    <body>
            ...
            <div class="col-10  ">
                ...
                <div class="container">
                    ...
                    <div class="row" style="display: grid; grid-template-columns: auto 1fr;">
                        <div class="col">
                            <h2 style="margin-right: auto;">บิลค่าห้อง</h2>
                        </div>
                        <div class="col-3">
                            ...
                            <tbody>
                                <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                                    <tr style="background-color: #fff;">
                                        ...
                                        <td style="text-align: center"><?php echo $row['name_bs'] ?></td>
                                        <?php if($row['status_b']==2){?>
                                        <td style="text-align: center"><a href="print_bill.php?id_b=<?php echo $row["id_b"] ?>" class="btn btn-info">พิมพ์</a></td>
                                        <td style="text-align: center"><a class="btn btn-warning-none">แก้ไข</a></td>
                                         <?php }else{?>
                                            <td style="text-align: center"><a href="print_bill.php?id_b=<?php echo $row["id_b"] ?>" class="btn btn-info">พิมพ์</a></td>
                                        <td style="text-align: center"><a href="edit_bill.php?id_b=<?php echo $row["id_b"] ?>" class="btn btn-warning">แก้ไข</a></td>
                                         <?php } ?>
                                        <td style="text-align: center">
                                            <a href="#" onclick="confirmDelete('<?php echo $row['id_b']; ?>')" class="btn btn-danger">ลบ</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
        ...
        <script>
            ...
            function confirmDelete(id) {
                ...
                if (result) {
                    window.location.href = "delete_bill.php?id_b=" + id;
