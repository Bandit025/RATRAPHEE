...
if (!$_SESSION['userid']) {
    ...
    $row2 = mysqli_fetch_assoc($resultu);
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="id_card" value="<?php echo $row2['id_card']; ?>">
                                        </div>
                                        <div class="mb-3">
                                            <label for="fname" class="form-label">วันที่ย้ายออก</label>
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="mb-3"><br><br>
                                            <button type="submit" class="btn btn-danger">แจ้งย้ายออก</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
