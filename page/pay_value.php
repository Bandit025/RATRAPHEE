            ...
            <main class="col-10">
                ...
                <div class="container">
                    ...
                    <div class="row" style="display: grid; grid-template-columns: auto 1fr;">
                        <div class="col">
                            <h2 style="margin-right: auto;">แนบบิลค่าห้อง</h2>
                        </div>
                        <div class="col-3">
                            ...
                            <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                                <tr style="background-color: #fff;">
                                    ...
                                    <?php if($row['status_b']==2){ ?>
                                        <td style="text-align: center"><a class="btn btn-success-none">แนบบิล</a>
                                    </td>
                                        
                                        <?php }else{?>
                                    <td style="text-align: center"><a href="pay_value_form.php?id_b=<?php echo $row["id_b"] ?>" class="btn btn-success">แนบบิล</a>
                                    </td>
                                    <?php } ?>
                                </tr>
                            <?php } ?>
