	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form action="register_db.php" method="post"class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid idcard is required: ex@abc.xyz">
						<input class="input100" type="text" name="id_card" placeholder="ID Card">
						<span class="focus-input100"></span>
						<!-- <span class="symbol-input100">
							<i class="fa fa-envelope" aria-hidden="true"></i>
						</span> -->
					</div>
					<div class="wrap-input100 validate-input" data-validate = "Valid tel is required: ex@abc.xyz">
